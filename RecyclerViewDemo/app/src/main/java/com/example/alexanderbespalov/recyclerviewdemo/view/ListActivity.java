...
import com.example.alexanderbespalov.recyclerviewdemo.data.FakeDataSource;
...
public class ListActivity extends AppCompatActivity  implements ViewInterface {
    ...
    @Override
    public void startDetailActivity(String dateAndTime, String message, int colorResourse) {
        Intent i = new Intent(this, DetailActivity.class);
        i.putExtra(EXTRA_DATE_AND_TIME, dateAndTime);
        i.putExtra(EXTRA_MESSAGE, message);
        i.putExtra(EXTRA_COLOUR, colorResourse);
    ...
    private class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.CustomViewHolder> {
        ...
        public void onBindViewHolder(CustomViewHolder holder, int position) {
            ...
            holder.coloredCircle.setBackgroundResource(currentItem.getColorResourse());
